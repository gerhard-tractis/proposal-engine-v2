...
export function WhyUs({ data }: BlockComponentProps) {
  ...
  return (
    ...
    >
      {/* Hero Statement */}
      <motion.div variants={fadeInUp(0)} className="text-center space-y-4">
      ...
      >
        <motion.div variants={staggerItem} {...hoverLift}>
          <Card className="group border-2 bg-gradient-to-br from-card to-card/50 h-full">
            <CardContent className="p-8 space-y-6">
              <div className="space-y-4">
                <motion.div
                  variants={scaleIn(0)}
                  className="p-3 rounded-xl bg-gradient-to-br from-purple-500/10 to-purple-600/10 w-fit group-hover:scale-110 transition-transform duration-300"
                >
                  <Brain className="h-8 w-8 text-purple-600 dark:text-purple-400" />
                </motion.div>
                <h3 className="text-xl font-bold text-card-foreground">AI + Logistics Experts</h3>
              </div>
          ...
          <Card className="group border-2 bg-gradient-to-br from-card to-card/50 h-full">
            <CardContent className="p-8 space-y-6">
              <div className="space-y-4">
                <motion.div
                  variants={scaleIn(0)}
                  className="p-3 rounded-xl bg-gradient-to-br from-blue-500/10 to-blue-600/10 w-fit group-hover:scale-110 transition-transform duration-300"
                >
                  <Server className="h-8 w-8 text-blue-600 dark:text-blue-400" />
                </motion.div>
                <h3 className="text-xl font-bold text-card-foreground">World-Class Infrastructure</h3>
              </div>
              <ul className="space-y-3 text-sm text-muted-foreground">
          ...
          <Card className="group border-2 bg-gradient-to-br from-card to-card/50 h-full">
            <CardContent className="p-8 space-y-6">
              <div className="space-y-4">
                <motion.div
                  variants={scaleIn(0)}
                  className="p-3 rounded-xl bg-gradient-to-br from-emerald-500/10 to-emerald-600/10 w-fit group-hover:scale-110 transition-transform duration-300"
                >
                  <Shield className="h-8 w-8 text-emerald-600 dark:text-emerald-400" />
                </motion.div>
                <h3 className="text-xl font-bold text-card-foreground">Security & Privacy</h3>
              </div>
              <ul className="space-y-3 text-sm text-muted-foreground">
      ...
      <motion.div variants={fadeInUp(0.2)} className="space-y-8">
        <div className="text-center space-y-2">
          <h3 className="text-3xl font-bold text-foreground">Proven Track Record</h3>
            ...
            <Card className="relative overflow-hidden h-full">
              ...
              <CardContent className="relative p-6 space-y-4">
                <div className="flex items-center gap-3">
                  <motion.div
                    variants={scaleIn(0)}
                    className="p-3 rounded-xl bg-gradient-to-br from-emerald-500/10 to-emerald-600/10"
                  >
                    <ShoppingCart className="h-6 w-6 text-emerald-600 dark:text-emerald-400" />
                  </motion.div>
                  <h4 className="text-lg font-bold text-card-foreground">FMCG/CPG</h4>
                </div>
            ...
            <Card className="relative overflow-hidden h-full">
              ...
              <CardContent className="relative p-6 space-y-4">
                <div className="flex items-center gap-3">
                  <motion.div
                    variants={scaleIn(0)}
                    className="p-3 rounded-xl bg-gradient-to-br from-blue-500/10 to-blue-600/10"
                  >
                    <Package className="h-6 w-6 text-blue-600 dark:text-blue-400" />
                  </motion.div>
                  <h4 className="text-lg font-bold text-card-foreground">E-commerce</h4>
                </div>
                <ul className="space-y-2.5 text-sm text-muted-foreground">
            ...
            <Card className="relative overflow-hidden h-full">
              ...
              <CardContent className="relative p-6 space-y-4">
                <div className="flex items-center gap-3">
                  <motion.div
                    variants={scaleIn(0)}
                    className="p-3 rounded-xl bg-gradient-to-br from-orange-500/10 to-orange-600/10"
                  >
                    <Truck className="h-6 w-6 text-orange-600 dark:text-orange-400" />
                  </motion.div>
                  <h4 className="text-lg font-bold text-card-foreground">Last Mile</h4>
                </div>
                <ul className="space-y-2.5 text-sm text-muted-foreground">
      ...
      >
        ...
        <div className="relative text-center space-y-2">
          <h3 className="text-3xl font-bold text-foreground">Our Three Pillars</h3>
        ...
        >
          <motion.div variants={staggerItem} className="flex flex-col items-center text-center space-y-4">
            <div className="relative">
              <div className="absolute inset-0 bg-primary/20 rounded-full blur-xl" />
              <motion.div
                variants={scaleIn(0)}
                className="relative flex h-16 w-16 items-center justify-center rounded-full bg-white dark:bg-slate-900 border-4 border-primary text-primary font-bold text-2xl shadow-lg"
              >
                1
              </motion.div>
            </div>
      ...
      {/* Closing Statement */}
      <motion.div variants={fadeInUp(0.4)} className="text-center pt-8">
