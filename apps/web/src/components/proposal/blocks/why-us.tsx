  ...
  return (
    <section className="space-y-16">
      ...
      <div className="grid gap-6 md:grid-cols-3">
        <div className="group rounded-xl border-2 border-border bg-gradient-to-br from-card to-card/50 p-8 space-y-6 hover:border-primary/50 hover:shadow-lg transition-all duration-300">
      ...
      {/* Three Pillars */}
      <div className="relative overflow-hidden rounded-2xl border-2 border-primary/30 bg-gradient-to-br from-primary/10 via-primary/5 to-transparent p-10 space-y-8">
        ...
        <div className="relative grid gap-8 md:grid-cols-3">
          <div className="flex flex-col items-center text-center space-y-4">
            <div className="relative">
              ...
              <div className="relative flex h-16 w-16 items-center justify-center rounded-full bg-white dark:bg-slate-900 border-4 border-primary text-primary font-bold text-2xl shadow-lg">1</div>
            </div>
          ...
          <div className="flex flex-col items-center text-center space-y-4">
            <div className="relative">
              <div className="absolute inset-0 bg-primary/20 rounded-full blur-xl" />
              <div className="relative flex h-16 w-16 items-center justify-center rounded-full bg-white dark:bg-slate-900 border-4 border-primary text-primary font-bold text-2xl shadow-lg">2</div>
            </div>
            <div className="space-y-2">
          ...
          <div className="flex flex-col items-center text-center space-y-4">
            <div className="relative">
              <div className="absolute inset-0 bg-primary/20 rounded-full blur-xl" />
              <div className="relative flex h-16 w-16 items-center justify-center rounded-full bg-white dark:bg-slate-900 border-4 border-primary text-primary font-bold text-2xl shadow-lg">3</div>
            </div>
            <div className="space-y-2">
